...
<template>
    <AppLayout title="Relaciones">
        <div class="max-w-6xl mx-auto px-6 mt-8 pb-16 space-y-6">
            ...
            <header class="flex items-end justify-between gap-4">
                ...
                <div class="flex items-center gap-3 bg-base-lvl-1 border border-base-lvl-2 rounded-full px-3 py-1.5">
                    <button class="text-body-3 hover:text-body-1 px-1 leading-none">‹</button>
                    <span class="font-medium text-body-1 text-sm tabular-nums">{{ period }}</span>
                    <button class="text-body-3 hover:text-body-1 px-1 leading-none">›</button>
                </div>
            </header>
