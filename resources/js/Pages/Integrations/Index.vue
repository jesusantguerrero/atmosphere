            ...
            <div class="h-auto mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div
                        ...
                        class="flex px-5 py-3 bg-base-600 shadow-md cursor-pointer">
                    <div>
                ...
                <div class="w-full integrations-form">
                    <div
                        class="grid grid-cols-3 px-5 py-3 my-2 font-bold text-gray-500 bg-base-600 cursor-pointer app-service__item"
...
<style lang="scss">
    .app-service__integration {
        @apply bg-base-600 text-gray-500 my-2 cursor-pointer px-5 py-3 font-bold;
