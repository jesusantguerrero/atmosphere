        ...
        <div class="mt-2">
          ...
          <div v-if="isMultiCurrency" class="px-4 md:px-0 mt-4">
            <div class="bg-blue-50 border border-blue-200 dark:bg-blue-500/10 dark:border-blue-500/25 rounded-lg p-4 mb-4">
              ...
              <!-- Conversion Preview -->
              <div v-if="showConversionInfo && needsConversion" class="mt-4 p-3 bg-yellow-50 border border-yellow-200 dark:bg-yellow-500/10 dark:border-yellow-500/25 rounded">
                <div class="text-sm">
